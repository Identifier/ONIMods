...
namespace DoorIcons
{
    public static class State
    {
        ...
        {
            Debug.Log($"[ConfigurableDoorIcons] Loading sprite from file: {ConfigurableDoorIcons.UserMod.RootPath}/Sprites/{spriteFilename}");
            if (ConfigurableDoorIcons.UserMod.RootPath == null)
            {
                return null;
            }
            ...
            var path = Pathfinder.MergePath(ConfigurableDoorIcons.UserMod.RootPath, "Sprites", spriteFilename);
            ...
            {
                Debug.LogError("[ConfigurableDoorIcons] File doesn't exist at path: " + path);
                return null;
            }
        }
    }
